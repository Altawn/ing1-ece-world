...
int jackpot(){
    ...
    gauche[0]=load_bitmap("../tete_carapuce.bmp",NULL);
    gauche[1]=load_bitmap("../tete_dracaufeu.bmp",NULL);
    gauche[2]=load_bitmap("../tete_rondoudou.bmp",NULL);

    milieu[0]=load_bitmap("../tete_carapuce.bmp",NULL);
    milieu[1]=load_bitmap("../tete_dracaufeu.bmp",NULL);
    milieu[2]=load_bitmap("../tete_rondoudou.bmp",NULL);

    droite[0]=load_bitmap("../tete_carapuce.bmp",NULL);
    droite[1]=load_bitmap("../tete_dracaufeu.bmp",NULL);
    droite[2]=load_bitmap("../tete_rondoudou.bmp",NULL);
