...
int main()
{
    ...
    //initialisation pour les collisions
    ...
    BITMAP* fond, * fond2, * t0, * t1, * t2, * tup0, * tup1, * tup2, * ts0, * ts1, * ts2, * page, * page2;
    BITMAP* e1, * e2, * e3, * e_s1, * e_s2, * e_s3, * e_u1, * e_u2, * e_u3, * quoi, * cent, * fin_jeu_final;
